...
const BlogCard = ({blog}:Props) => {
  ...
  return (
    <div className='bg-indigo-950 rounded-md overflow-hidden'>
        <Image src={image} alt={title} width={500} height={300} className='w-full h-[250px] object-cover' />
        <div className="p-6">
            <div className="rounded-sm px-6 py-1.5 bg-rose-500 text-white w-fit">
                News
            </div>
            ...
            <div className="mt-4 mb-4 w-full h-[1.5px] bg-gray-400 opacity-40"></div>
