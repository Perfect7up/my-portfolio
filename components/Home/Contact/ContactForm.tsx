  ...
  return (
    <div className="bg-[#140c1c] rounded-lg p-4 sm:p-10">
      ...
      <p className="text-gray-200 mt-3 lg:text-base text-xs md:text-sm">
        Collaboration fosters creativity, trust, and innovation, ensuring
        efficient teamwork and successful outcomes for every project.
      </p>
      <form className="mt-8 block w-full overflow-hidden">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <input
            ...
            className="flex-1 bg-black text-white placeholder:text-gray-600 px-6 py-3 rounded-md border-opacity-15 outline-none w-full"
          />
          <input
            type="text"
